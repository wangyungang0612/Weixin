...
public class CreatChatRoomActivity extends Activity {
    ...
    ImageView ivSearch;
    @InjectView(R.id.linearLayoutMenu)
    LinearLayout linearLayoutMenu;
    @InjectView(R.id.horizonMenu)
    HorizontalScrollView horizonMenu;
    @InjectView(R.id.et_search)
    EditText etSearch;
    @InjectView(R.id.choose_crowd)
    TextView chooseCrowd;
    @InjectView(R.id.mian_jianqun)
    TextView mianJianqun;
...
//        iv_search = (ImageView) this.findViewById(R.id.iv_search);
    ...
    @OnClick({R.id.iv_back,R.id.tv_checked, R.id.iv_search, R.id.et_search, R.id.choose_crowd, R.id.mian_jianqun})
    public void onClick(View view) {
        switch (view.getId()) {
            ...
            case R.id.et_search:
                break;
            case R.id.choose_crowd:
                break;
            case R.id.mian_jianqun:
                break;
        }
    }
