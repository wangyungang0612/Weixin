...
public class MessageBoxListAdapter extends BaseAdapter {
	...
	public View getView(int position, View convertView, ViewGroup parent){
		...
		layout_child = (RelativeLayout) layout_father.findViewById(R.id.layout_bj);
	...
	public void addListener(final TextView tvText, final TextView tvDate, RelativeLayout layout_bj, final MessageBean mb){
