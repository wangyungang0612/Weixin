...
public class NewSMSActivity extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		notinputmethod = (Button) findViewById(R.id.duomeiti);
		notinputmethod.setOnClickListener(new OnClickListener() {
			public void onClick(View v) {

				//隐藏输入法			
				
				((InputMethodManager)getSystemService(Context.INPUT_METHOD_SERVICE)).hideSoftInputFromWindow(NewSMSActivity.this.getCurrentFocus().getWindowToken(), InputMethodManager.HIDE_NOT_ALWAYS);
			}
		});
